...
$convert "$1" -resize 76x76 "$3/icon/ios/icon-76.png"
...
$convert "$1" -resize 120x120 "$3/icon/ios/icon-120.png"
$convert "$1" -resize 152x152 "$3/icon/ios/icon-152.png"
...
$convert -resize 512x512 -extent 640x960 "$3/screen/ios/screen-iphone-portrait-2x.png"
